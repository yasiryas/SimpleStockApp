<x-app-layout>
    ...
    <div x-data="stockModal()" class="space-y-4">
        ...
        <template x-if="pagination && pagination.last_page > 1">
            <div class="mt-4 px-5 py-4 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        function stockModal() {
            return {
                ...
                async init() {
                    ...
                    this.pollingInterval = setInterval(() => this.fetchMovements(), 5000);
                },
