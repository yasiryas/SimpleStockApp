    ...
    <div x-data="dashboardFilter()">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900 mt-1">{{ $products->sum('stok_saat_ini') }}</p>
            </div>
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <p class="text-sm font-medium text-gray-500">Stok Menipis</p>
                <p class="text-2xl font-bold text-red-600 mt-1">{{ $products->where('stok_saat_ini', '<=', 5)->count() }}</p>
            </div>
        </div>
